...
export const productsTableMeta = {
        ...
        <Dropdown>
          ...
          <DropdownMenu aria-label="Product actions">
            <DropdownItem
              ...
              onPress={() => context.onEdit(product)}
            >
              Edit
            </DropdownItem>
            <DropdownItem
              ...
              onPress={() => context.onDelete(product.id)}
            >
              Delete
            </DropdownItem>
          </DropdownMenu>
...
export type ProductsTableProps = PaginationTableProps<Product>;
